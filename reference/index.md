...
- [`plot_neutral_model()`](http://www.germslab.org/BRCore/reference/plot_neutral_model.md)
  : Plot a fitted Neutral Model to Microbial Community Data
- [`sncm.fit()`](http://www.germslab.org/BRCore/reference/sncm.fit.md) :
...
- [`bcse`](http://www.germslab.org/BRCore/reference/bcse.md) : 16S
...
- [`bean`](http://www.germslab.org/BRCore/reference/bean.md) : 16S
  amplicon dataset from common bean (Phaseolus vulgaris)
- [`mimulus`](http://www.germslab.org/BRCore/reference/mimulus.md) : 16S
