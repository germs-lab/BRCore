...
test_that("extract_core() works with esophagus_with_tax dataset", {
  ...
  sample_data <- data.frame(
    ...
    Group = sample(c("A", "B"), nsamples(esophagus), replace = TRUE),
    # Random groups
  ...
  # Load expected
  #load(here::here("tests/testthat/testdata/expected_extract_core.rda"))
  load(testthat::test_path("testdata", "expected_extract_core.rda"))
