...
test_that("plot_identified_core returns a ggplot and builds", {
    ...
    testthat::skip_if_not(exists("plot_identified_core"), "plot_identified_core() not found")
    ...
    p <- plot_identified_core(bray_curtis_ranked, elbow = elbow, lastCall = lastCall)
