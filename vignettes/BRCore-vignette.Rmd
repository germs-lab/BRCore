...
✔ Generating rarefaction diagnostic plots [813ms]
...
#> bcse100 bcse101 bcse102 bcse103 bcse104 bcse106 bcse107 bcse109 bcse111 bcse191 bcse192  bcse49  bcse50  bcse51  bcse57 
#>    1000    1000    1000    1000    1000    1000    1000    1000    1000    1000    1000    1000    1000    1000    1000 
#>  bcse58  bcse59  bcse61  bcse62  bcse63  bcse65  bcse66  bcse67  bcse68  bcse69  bcse70  bcse71  bcse72  bcse73  bcse75 
#>    1000    1000    1000    1000    1000    1000    1000    1000    1000    1000    1000    1000    1000    1000    1000 
#>  bcse76  bcse77  bcse78  bcse79  bcse80  bcse81  bcse82  bcse83  bcse85  bcse86  bcse87  bcse88  bcse95  bcse96  bcse97 
#>    1000    1000    1000    1000    1000    1000    1000    1000    1000    1000    1000    1000    1000    1000    1000 
#>  bcse98  bcse99 
#>    1000    1000
bcse_rarefied_otutable[1:10, 1:10]
#>         OTU_427 OTU_11 OTU_253 OTU_148  OTU_3 OTU_78 OTU_58 OTU_152 OTU_16 OTU_35
#> bcse100     0.0   0.00       0   10.91 191.70   0.00   0.00    0.00   1.18      0
#> bcse101     0.0   0.00       0    0.00 146.35   0.00   0.00    0.00   0.24      0
#> bcse102     0.0   0.00       0    0.00  99.65   0.00   0.00    0.00   0.14      0
#> bcse103     0.0   0.09       0    0.00 121.97   0.00   0.00    0.00   0.28      0
#> bcse104     0.0   0.00       0    0.08  76.69   0.00   0.00    0.00   1.19      0
#> bcse106     0.0   0.00       0    1.46 335.31   0.00   0.00    0.00   0.00      0
#> bcse107     0.6   0.62       0    0.61 166.35   3.02   3.63    0.61   1.69      0
#> bcse109     0.0   0.32       0    0.65 170.70   0.26   0.00    0.00   4.41      0
#> bcse111     0.0   0.00       0    0.15 201.20   0.00   0.00    0.00   0.16      0
#> bcse191     0.0   0.00       0    7.39 248.33   0.00   0.00    0.00   0.24      0
```
...
#>  [1] "bcse50"  "bcse69"  "bcse73"  "bcse191" "bcse82"  "bcse102" "bcse111" "bcse86"  "bcse97"  "bcse88"  "bcse104"
#> [12] "bcse108" "bcse81"  "bcse77"  "bcse78"  "bcse96"  "bcse66"  "bcse57"  "bcse75"  "bcse101" "bcse192" "bcse98" 
#> [23] "bcse105" "bcse106" "bcse76"  "bcse103" "bcse51"  "bcse63"  "bcse68"  "bcse109" "bcse65"  "bcse58"  "bcse107"
#> [34] "bcse62"  "bcse59"  "bcse99"  "bcse49"  "bcse85"  "bcse79"  "bcse72"  "bcse80"  "bcse71"  "bcse110" "bcse95" 
#> [45] "bcse67"  "bcse61"  "bcse100" "bcse87"  "bcse83"  "bcse70"
#> Sample names in the rarefied OTU table (data.frame) after reordering to match phyloseq:
#>  [1] "bcse50"  "bcse69"  "bcse73"  "bcse191" "bcse82"  "bcse102" "bcse111" "bcse86"  "bcse97"  "bcse88"  "bcse104"
#> [12] "NA"      "bcse81"  "bcse77"  "bcse78"  "bcse96"  "bcse66"  "bcse57"  "bcse75"  "bcse101" "bcse192" "bcse98" 
#> [23] "NA.1"    "bcse106" "bcse76"  "bcse103" "bcse51"  "bcse63"  "bcse68"  "bcse109" "bcse65"  "bcse58"  "bcse107"
#> [34] "bcse62"  "bcse59"  "bcse99"  "bcse49"  "bcse85"  "bcse79"  "bcse72"  "bcse80"  "bcse71"  "NA.2"    "bcse95" 
#> [45] "bcse67"  "bcse61"  "bcse100" "bcse87"  "bcse83"  "bcse70"
...
#>  bcse50  bcse69  bcse73 bcse191  bcse82 bcse102 bcse111  bcse86  bcse97  bcse88 bcse104  bcse81  bcse77  bcse78  bcse96 
#>    1000    1000    1000    1000    1000    1000    1000    1000    1000    1000    1000    1000    1000    1000    1000 
#>  bcse66  bcse57  bcse75 bcse101 bcse192  bcse98 bcse106  bcse76 bcse103  bcse51  bcse63  bcse68 bcse109  bcse65  bcse58 
#>    1000    1000    1000    1000    1000    1000    1000    1000    1000    1000    1000    1000    1000    1000    1000 
#> bcse107  bcse62  bcse59  bcse99  bcse49  bcse85  bcse79  bcse72  bcse80  bcse71  bcse95  bcse67  bcse61 bcse100  bcse87 
#>    1000    1000    1000    1000    1000    1000    1000    1000    1000    1000    1000    1000    1000    1000    1000 
#>  bcse83  bcse70 
#>    1000    1000
```
...
#> ℹ Ranking OTUs based on BC dissimilarity, starting at 2025-12-22 22:08:02.668628
#> ✔ Elbow method identified 9 core OTUs
#> ✔ % increase method identified 33 core OTUs
#> ✔ Analysis complete!
```
...
![plot of chunk fig4_plot_elbow](images/fig4_plot_elbow-1.png)
...
#>  [1] BRCore_1.0.0      viridis_0.6.5     viridisLite_0.4.2 lubridate_1.9.4   forcats_1.0.0     stringr_1.6.0    
#>  [7] dplyr_1.1.4       purrr_1.2.0       readr_2.1.5       tidyr_1.3.1       tibble_3.3.0      ggplot2_4.0.1    
#> [13] tidyverse_2.0.0   phyloseq_1.54.0   here_1.0.1        knitr_1.50        devtools_2.4.5    usethis_3.1.0    
#> 
#> loaded via a namespace (and not attached):
#>   [1] RColorBrewer_1.1-3  sys_3.4.3           rstudioapi_0.17.1   jsonlite_2.0.0      magrittr_2.0.4     
#>   [6] farver_2.1.2        rmarkdown_2.30      fs_1.6.6            vctrs_0.6.5         multtest_2.66.0    
#>  [11] memoise_2.0.1       askpass_1.2.1       base64enc_0.1-3     rstatix_0.7.3       htmltools_0.5.9    
#>  [16] curl_7.0.0          broom_1.0.11        Rhdf5lib_1.32.0     Formula_1.2-5       rhdf5_2.54.1       
#>  [21] parallelly_1.45.1   desc_1.4.3          htmlwidgets_1.6.4   testthat_3.2.3      plyr_1.8.9         
#>  [26] cachem_1.1.0        commonmark_1.9.2    igraph_2.2.1        mime_0.13           lifecycle_1.0.4    
#>  [31] minpack.lm_1.2-4    iterators_1.0.14    pkgconfig_2.0.3     Matrix_1.7-2        R6_2.6.1           
#>  [36] fastmap_1.2.0       rcmdcheck_1.4.0     shiny_1.10.0        digest_0.6.39       colorspace_2.1-2   
#>  [41] ps_1.8.1            S4Vectors_0.48.0    rprojroot_2.0.4     pkgload_1.4.0       Hmisc_5.2-4        
#>  [46] ggpubr_0.6.2        vegan_2.7-2         labeling_0.4.3      timechange_0.3.0    abind_1.4-8        
#>  [51] mgcv_1.9-4          compiler_4.5.2      remotes_2.5.0       withr_3.0.2         htmlTable_2.4.3    
#>  [56] S7_0.2.1            backports_1.5.0     carData_3.0-5       pkgbuild_1.4.6      ggsignif_0.6.4     
#>  [61] MASS_7.3-64         openssl_2.3.2       sessioninfo_1.2.3   biomformat_1.38.0   ggsci_4.1.0        
#>  [66] permute_0.9-8       tools_4.5.2         foreign_0.8-88      ape_5.8-1           httpuv_1.6.15      
#>  [71] nnet_7.3-20         glue_1.8.0          callr_3.7.6         nlme_3.1-167        rhdf5filters_1.22.0
#>  [76] promises_1.3.2      grid_4.5.2          checkmate_2.3.3     cluster_2.1.8       reshape2_1.4.5     
#>  [81] ade4_1.7-23         generics_0.1.4      gtable_0.3.6        tzdb_0.4.0          data.table_1.17.8  
#>  [86] hms_1.1.3           xml2_1.3.6          car_3.1-3           XVector_0.50.0      BiocGenerics_0.56.0
#>  [91] ggrepel_0.9.6       foreach_1.5.2       pillar_1.11.1       later_1.4.1         splines_4.5.2      
#>  [96] lattice_0.22-7      survival_3.8-3      tidyselect_1.2.1    Biostrings_2.78.0   miniUI_0.1.1.1     
#> [101] gridExtra_2.3       IRanges_2.44.0      Seqinfo_1.0.0       stats4_4.5.2        xfun_0.54          
#> [106] Biobase_2.70.0      credentials_2.0.2   brio_1.1.5          stringi_1.8.7       xopen_1.0.1        
#> [111] evaluate_1.0.5      codetools_0.2-20    cli_3.6.5           rpart_4.1.24        xtable_1.8-4       
#> [116] roxygen2_7.3.3      processx_3.8.5      gert_2.1.5          Rcpp_1.1.0          parallel_4.5.2     
#> [121] ellipsis_0.3.2      prettyunits_1.2.0   profvis_0.4.0       urlchecker_1.0.1    scales_1.4.0       
#> [126] crayon_1.5.3        rlang_1.1.6         cowplot_1.2.0
```
