...
#> ℹ Generating rarefaction diagnostic plots✔ Generating rarefaction diagnostic plots [1.5s]
...
#> Error in multi_rarefy(physeq_obj = bcse, depth_level = 1000, num_iter = 10, : unused argument (.as_array = FALSE)
```
...
#> Error in identify_core(physeq_obj = bcse, priority_var = "Crop", increase_value = 0.02, : unused argument (num_iter = 10)
```
